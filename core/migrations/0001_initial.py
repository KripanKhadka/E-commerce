    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('FB', 'Football / Soccer'), ('BK', 'Basketball'), ('TN', 'Tennis & Racket Sports'), ('RN', 'Running & Fitness'), ('OW', 'Outdoor & Hiking'), ('AP', 'Sports Apparel & Accessories')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger')], max_length=1)),
                ('slug', models.SlugField()),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to='')),
                ('brand', models.CharField(blank=True, default='Generic', max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Address',
